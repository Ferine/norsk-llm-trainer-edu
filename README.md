...
| 2 | **Raw text & tokenization** | See the Norwegian corpus, watch a sentence split into characters, and inspect the full character-level vocabulary. A compact multimodal visual also shows how image patches and short audio frames become ordered sequences of numeric representations. |
